...
**Status:** Shipped 2026-08-04, on branch `feat/m6-settings-edit`. Written against [design-tui.md](design-tui.md) §14.2, [requirements.md](requirements.md) revision 8 (R11.7, R11.8) and shipped M1–M6. Owned by M6; the summary of these tasks lives in [plan-m6.md § Extension: editable Settings](plan-m6.md#extension-editable-settings), which this document is the executable form of.
