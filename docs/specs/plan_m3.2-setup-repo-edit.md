...
**Status:** Shipped 2026-08-10, on branch `worktree-m3-setup-repo-edit`. Written against [design_tui.md](design_tui.md) §14.13, [design.md](design.md) §5.3, [requirements.md](requirements.md) revision 23 (R3.12) and shipped M1–M4.1. Owned by M3, which owns the wizard.
