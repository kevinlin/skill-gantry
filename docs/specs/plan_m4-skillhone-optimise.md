...
Amended R3.1, R3.5, R3.8 and R11.20 in place; added R6.12, R11.21 and R12.8 with the M9 milestone-ownership row. Amended design.md §5.1a, §5.2, §5.3, added §9.4a. Added design_tui.md §14.10 and a decision-log entry reinstating SkillHone as a skill bundle, superseding §10's omission.
