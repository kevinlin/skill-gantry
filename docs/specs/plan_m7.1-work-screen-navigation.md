...
| index.md | row for this plan; plan_m7-work-screen-overhaul.md's status; two pre-existing catalogue defects fixed — the `plan_m6.1-settings-edit.md` dead link and the orphan `plan_m2.1-rehydrate-the-last-recorded-run.md` |
| plan_m7-work-screen-overhaul.md | `## Changelog` pointing here |
...
**Files:** Modify: `docs/specs/requirements.md`, `docs/specs/design_tui.md`, `docs/specs/design.md`, `docs/specs/index.md`, `docs/specs/plan_m8-suppress-finding.md`. Create: this file.
...
- [x] **Step 3:** design.md §17 and §18; index.md rows and the two catalogue defects; plan_m8-suppress-finding.md `## Changelog`.
